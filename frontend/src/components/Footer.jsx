      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-neutral-400 text-sm max-w-md">
              Discover and create unforgettable events. Connect with people who share your passions
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/register" className="text-sm text-neutral-400 hover:text-white transition-colors">
                  Create Account
                </Link>
              </li>
              <li>
                <Link to="/events/create" className="text-sm text-neutral-400 hover:text-white transition-colors">
                  Host an Event
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-neutral-500">
            © {new Date().getFullYear()} OneLastEvent. All rights reserved.
          </p>
